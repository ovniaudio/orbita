...
> **Nota:** ORBIT viaja también en el DMG del catálogo (`ovni/dist/OVNI-v0.1.0.dmg`) junto a
> los 6 plugins del repo OVNI. La atribución de **Intel IPP** aparece por eso tanto acá como
> en [`ovni/NOTICE.md`](../ovni/NOTICE.md). Los 6 plugins OVNI **no** usan IPP; **ORBIT sí**.
...
- **Uso en el proyecto:** la HRIR horneada en `source/dsp/HrirData.h` y `source/dsp/HrirRing.h`
  ...
  más limpia para uso comercial — ver [`ovni/NOTICE.md`](../ovni/NOTICE.md); ORBIT conserva
  el bake CIPIC histórico.
